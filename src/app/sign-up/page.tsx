...
const optionBizTypes: Option[] = [
    ...
    { value: "none_profit", label: "None Profit" },
];

const formattedCountryCodes = countryCodes.map((item) => ({
    value: item.code,
    label: `${item.flag} ${item.country} (${item.code})`
}));

const page = () => {
    const router = useRouter();
    const [country, setCountry] = useState<Option | null>(null);
    const [businessType, setBusinessType] = useState<Option | null>(null);
    ...
    const formik = useFormik({
        ...
        onSubmit: async (values, { setSubmitting, setErrors }) => {
            ...
            const response = await fetch('https://payfixy-website-5.onrender.com/main/onboarding/', {
              ...
              // You can redirect user to dashboard after successful sign-up
    ...
    const handleChangeBizType = (option: Option | null) => {
        setBusinessType(option);
        // console.log("Selected BizType:", option);
    };
                            ...
                            {activeTab !== 'one' &&
                                <>
                                    <InputField
                                        ...
                                        type="text"
                                        required
                                        className={`${formik.touched.business_type && formik.errors.business_type
                                    ...
                                    <div className="flex items-center gap-3">
                                      ...
                                      <Button type="submit"  disabled={formik.isSubmitting || !termsAccepted} isLoading={formik.isSubmitting}>
